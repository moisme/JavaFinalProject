...
@Entity
@Table(name = "patient")
@NamedQuery(name = Patient.ALL_PATIENTS_QUERY, query = "SELECT p FROM Patient p")
@NamedQuery(name = Patient.SPECIFIC_PATIENT_QUERY, query = "SELECT p FROM Patient p WHERE p.id = :patientId")
...
public class Patient extends PojoBase implements Serializable {
	...
	public static final String SPECIFIC_PATIENT_QUERY = "Patient.findOne";
