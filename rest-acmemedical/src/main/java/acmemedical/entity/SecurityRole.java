...
@NamedQuery(name = SecurityRole.QUERY_ROLE, query = "SELECT r FROM SecurityRole r WHERE r.roleName = :roleName")
public class SecurityRole implements Serializable {
    /** Explicit set serialVersionUID */
    private static final long serialVersionUID = 1L;

    public static final String QUERY_ROLE = "SecurityRole.findByName";
